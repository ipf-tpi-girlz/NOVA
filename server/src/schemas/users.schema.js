...
export const registerUserSchema = z
  .object({
    ...
    mail: z.string().email({ message: "Correo electrónico no válido" }),
    departamento: z
      .string()
      .min(1, { message: "El departamento es obligatorio" }),
    localidad: z.string().min(1, { message: "La localidad es obligatoria" }),
    contrasenia: z
      .string()
    ...
    nro_matricula: z.string().optional().or(z.literal("").optional()), // Solo para el rol 'profesional'
    cuit: z
      .string("El CUIT es requerido")
      .optional()
      .or(z.literal("").optional()), // Se valida condicionalmente en superRefine
    razon_social: z
      .string("La razón social es requerida")
      .optional()
      .or(z.literal("").optional()), // Solo para el rol 'institucion'
    direccion: z
      .string("La direccion es requerida")
      .optional()
      .or(z.literal("").optional()), // Solo para el rol 'institucion'
  })
...
export const updateUserSchema = z
  .object({
    role: z.enum(["victima", "profesional", "institucion"]).optional(),
    ...
    nro_telefono: z
      ...
      .optional(),
    nro_matricula: z.string().optional().or(z.literal("").optional()),
    cuit: z
      .string("El CUIT es requerido")
      .optional()
