export const Nosotros = () => {
  ...
  historyConteiner.className =
    "container mx-auto flex flex-col md:flex-row gap-10 px-4";
  ...
  commitTitle.className =
    "text-5xl font-bold font-serif text-center text-gray-800 mb-8";
  commitTitle.textContent = "Nuestro compromiso";

  // Card 1: Privacidad
  const cardCommit1 = document.createElement("div");
  cardCommit1.className =
    "bg-base-100 bg-cover rounded-lg shadow-md p-6 flex flex-col items-center transition-all duration-300 ease-in-out transform hover:shadow-lg hover:scale-105";
  ...
  cardsContainer.className =
    "container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 ";

  // Card de Artículos
  const cardArticle = document.createElement("div");
  cardArticle.className =
    "bg-base-100  rounded-lg shadow-md p-6 flex flex-col items-center transition-all duration-300 ease-in-out transform hover:shadow-lg hover:scale-105";
  ...
  articleButton.className =
    "mt-4 bg-gradient-to-r from-purple-500 to-purple-700 text-white py-2 px-6 rounded-lg transition-all duration-300 hover:from-purple-600 hover:to-purple-800";
  ...
  communityButton.className =
    "mt-4 bg-gradient-to-r from-purple-600 to-purple-800 text-white py-2 px-6 rounded-lg transition-all duration-300 hover:from-purple-700 hover:to-purple-900";
