export const foro = () => {
    ...
    title.classList.add("text-4xl", "font-bold", "font-serif", "text-center", "p-12");
...
card.classList.add('relative', 'flex', 'flex-col', 'mt-6', 'text-gray-700', 'bg-white', 'shadow-md', 'bg-clip-border', 'rounded-xl', 'w-72');

// Imagen de la tarjeta
const imgWrapper = document.createElement('div');
imgWrapper.classList.add('relative', 'h-56', 'mx-4', '-mt-6', 'overflow-hidden', 'text-white', 'shadow-lg', 'bg-clip-border', 'rounded-xl', 'bg-blue-gray-500', 'shadow-blue-gray-500/40');

const img = document.createElement('img');
img.src = "https://images.pexels.com/photos/4659806/pexels-photo-4659806.jpeg?auto=compress&cs=tinysrgb&w=600";
img.alt = 'card-image';
...
cardTitle.classList.add('block', 'mb-2', 'font-sans', 'text-xl', 'antialiased', 'font-semibold', 'leading-snug', 'tracking-normal', 'text-blue-gray-900');
cardTitle.textContent = 'Manos Unidas';

const cardText = document.createElement('p');
cardText.classList.add('block', 'font-sans', 'text-base', 'antialiased', 'font-light', 'leading-relaxed', 'text-inherit');
cardText.textContent = 'Somos una comunidad en busca de la sanacion al trauma, un espacio para poder expresarte e interactuar con otros que han pasado lo mismo.';
...
button.classList.add('align-middle', 'select-none', 'font-sans', 'font-bold', 'text-center', 'uppercase', 'transition-all', 'disabled:opacity-50', 'disabled:shadow-none', 'disabled:pointer-events-none', 'text-xs', 'py-3', 'px-6', 'rounded-lg', 'bg-gray-900', 'text-white', 'shadow-md', 'shadow-gray-900/10', 'hover:shadow-lg', 'hover:shadow-gray-900/20', 'focus:opacity-[0.85]', 'focus:shadow-none', 'active:opacity-[0.85]', 'active:shadow-none');
button.type = 'button';
...
// const posts = [
//   { id: 1, title: "Bienvenidos al foro", content: "Este es nuestro primer post. ¡Comenta y comparte tus pensamientos!", comments: [] },
//   { id: 2, title: "Tema del día: Minimalismo", content: "¿Qué opinas sobre el estilo de vida minimalista?", comments: [] }
// ];

// Crear el título del foro
const appContainer = document.getElementById('div');

const forumTitle = document.createElement('h1');
forumTitle.textContent = 'Foro Minimalista';
forumTitle.classList.add('text-3xl', 'font-semibold', 'mb-6', 'text-center', 'text-gray-800');
...
formContainer.classList.add('mt-8', 'bg-white', 'p-6', 'rounded-lg', 'shadow-md');
...
postSubmitButton.classList.add('bg-blue-500', 'text-white', 'px-4', 'py-2', 'rounded', 'hover:bg-blue-600', 'transition');
...
function renderPosts() {
  ...
  posts.forEach(post => {
      ...
      postTitle.classList.add('text-xl', 'font-semibold', 'mb-2', 'text-gray-800');
      ...
      commentSubmitButton.classList.add('mt-2', 'bg-gray-200', 'text-gray-700', 'px-3', 'py-1', 'rounded', 'hover:bg-gray-300', 'transition');
