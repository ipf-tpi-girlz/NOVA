...
export const ContactsPage = () => {
  ...
  img.setAttribute(
    'src',
    'https://www.lamañanaonline.com.ar/media/fotos/menu_20200611003404.jpg'
  )
  img.classList.add(
    'absolute',
    'inset-0',
  ...
  gradientEffectSpan.classList.add(
    'absolute',
    'inset-x-0',
    'bottom-0',
    'h-2',
  ...
  articleDescription.classList.add(
    'mt-4',
    'text-pretty',
    'text-sm',
    'text-base-500'
  ...
  main.appendChild(contactospreviw)
