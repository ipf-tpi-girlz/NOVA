...
export const HeaderProfile = () => {
  ...
  const $main = createElementWithClasses("div", [
    "flex",
    "flex-col",
    "min-h-screen",
    "w-full",
  ...
  const $header = createElementWithClasses("div", [
    "flex",
    "flex-col",
    "md:flex-row",
    "items-center",
  ...
  const $textContainer = createElementWithClasses("div", [
    "flex",
    "flex-col",
    "justify-start",
    "text-center",
  ...
  const $name = createElementWithClasses("h2", [
    "text-3xl",
    "md:text-4xl",
    "font-bold",
    "text-gray-800",
  ...
  const $bio = createElementWithClasses("p", [
    "text-gray-600",
    "mb-4",
    "max-w-lg",
  ]);
  const $stats = createElementWithClasses("div", [
    "flex",
    "gap-4",
    "text-sm",
    "text-gray-500",
      ...
      fetchGetForosById()
        .then((foros) => {
          ...
          const comunidadesCount =
            user.comunidades && Array.isArray(user.comunidades)
              ? user.comunidades.length
              : 0;
        ...
        .catch((error) => {
          ...
          $stats.innerHTML =
            "<span>0</span> foros<span>•</span><span>0</span> comunidades";
        });
    })
    .catch((error) => {
  ...
  const $leftColumn = createElementWithClasses("div", [
    "flex-1",
    "bg-white",
    "rounded-3xl",
    "shadow-lg",
  ...
  const $leftTitleContainer = createElementWithClasses("div", [
    "flex",
    "justify-between",
    "items-center",
    "mb-6",
  ]);
  const $leftTitle = createElementWithClasses("h3", [
    "text-2xl",
    "font-bold",
    "text-gray-800",
    "flex",
  ...
  const $createButton = createElementWithClasses("button", [
    "bg-indigo-500",
    "hover:bg-indigo-600",
    "text-white",
    "py-2",
  ...
  $createButton.innerHTML =
    '<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>Crear';
  ...
  const publicacionesContainer = createElementWithClasses("div", [
    "grid",
    "grid-cols-1",
    "sm:grid-cols-2",
    "lg:grid-cols-3",
  ...
  const $rightTitle = createElementWithClasses("h3", [
    "text-2xl",
    "font-bold",
    "mb-6",
    "text-gray-800",
...
const createPublicationCard = (post) => {
  ...
  const cardTitle = createCardElement(
    "h4",
    ["font-bold", "text-lg", "mb-2"],
    post.nombre
  );
  const cardDesc = createCardElement(
    "p",
...
const createDropdownMenu = (foro) => {
  ...
  const dropdownButton = createCardElement(
    "div",
    ["btn", "bg-transparent", "border-transparent", "box-border-0"],
    "🤍"
  );
  ...
  const itemEliminar = createDropdownItem("Borrar", () =>
    deletePublication(foro.id)
  );
