export const  createHeroSection= () => {
    ...
    hero.classList.add("hero", "bg-base", "min-h-screen", "flex-row");
    ...
    form.classList.add( "flex-col", "items-center", "border", "mb-2", "w-[300px]", "bg-white", "rounded-lg" );
    ...
    titlepost.classList.add("p-2", "border", "mb-2", "w-[300px]")
    titlepost.placeholder = "titulo"
  ...
  form.appendChild(titlepost)
    ...
    maxWmd.classList.add("max-w-md",  "border", "mb-2", "w-[300px]", "bg-white", "rounded-lg" );
